    ...
    >
      <div className="h-[62.125rem] w-[62.813rem] absolute !m-[0] bottom-[-18.312rem] left-[12.813rem]">
        ...
        <img
          ...
          loading="lazy"
          alt=""
          src="/digital-business-organizer-for-time-management1@2x.png"
        />
        <img
          className="absolute top-[27.063rem] left-[1rem] w-[14.063rem] h-[16.75rem] object-contain z-[1]"
          loading="lazy"
          alt=""
          src="/task-management-system-for-productivity1@2x.png"
        />
      </div>
      ...
      <div className="h-[40.813rem] w-[15.375rem] flex flex-col items-end justify-start gap-[18.25rem] mq1150:hidden">
        <img
          ...
          loading="lazy"
          alt=""
          src="/planner-calendar-for-time-management1@2x.png"
        />
        <div className="self-stretch flex flex-row items-start justify-start">
          <img
            ...
            loading="lazy"
            alt=""
            src="/agile-management-system-on-laptop1@2x.png"
          />
        </div>
      </div>
    </section>
